...
namespace EPS
{
    public partial class UCCommonRailInjector : UserControl
    {
       ...
       // List<CriPruefschritte> criPruefschritte;
        ...
        public UCCommonRailInjector(List<CriPruefschritte> listCriPruefschritte, CriKomponenten criKomponenten)
        {
            InitializeComponent();
            _ListCriPruefschritte = listCriPruefschritte.OrderBy(p => p.PruefschrittNr).ToList();
         //   orderListAndInit(listCriPruefschritte);
...
//VL
        ...
        private void btnStartTest_Click(object sender, EventArgs e)
        {
            ...
            if (ckbOneTestStep.Checked)//آیا کاربردرخواست تست تک مرحله را دارد
            {
                //شماره تست جاری
                 indexOfTest = criPruefschritteBindingSource.IndexOf(criPruefschritteBindingSource.Current); 
            }
            else
            {
                indexOfTest = -1;
            ...
            (this.Parent.Parent as Form1).manageUC(_CriKomponenten, (short)EnumsUC.UCTestEPS, indexOfTest);
        ...
        private void GetParamDataUC()
        {
            ...
            rtxtPram.Text = "Pressure:" + Pressure +"\r\n";
            rtxtPram.Text += "ferq:" + ferq + "\r\n";
            rtxtPram.Text += "ActutionTime:" + ActutionTime + "\r\n";
            rtxtPram.Text += "ActuationProfile:" + ActuationProfile + "\r\n";
            rtxtPram.Text += "MeasurementTime:" + MeasurementTime + "\r\n";
            rtxtPram.Text += "InjectedFuelQuantity:" + InjectedFuelQuantity;
